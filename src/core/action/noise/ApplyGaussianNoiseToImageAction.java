...
public class ApplyGaussianNoiseToImageAction {
    ...
    public Image execute(double percent, double mu, double sigma) {
        ...
        int[][] newRedLevelMatrix = this.imageOperationsService.toValidContaminatedImage(redChannelValues, pixelsToContaminate);
        int[][] newGreenLevelMatrix = this.imageOperationsService.toValidContaminatedImage(greenChannelValues, pixelsToContaminate);
        int[][] newBlueLevelMatrix = this.imageOperationsService.toValidContaminatedImage(blueChannelValues, pixelsToContaminate);
